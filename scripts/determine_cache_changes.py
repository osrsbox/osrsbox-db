...
items: data/items-cahce-data.json
monsters: data/monsters-cache-data.json

When generated, both files should exist in:

extractions_tools_cache/

Then the files should be copied to:
...
def determine_cache_changes_items():
