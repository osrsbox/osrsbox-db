...
from extraction_tools_cache import extract_monsters_cache_data
...
if __name__ == '__main__':
    ...
    print(">>> MONSTERS: Extracting and merging OSRS attackable NPC definition files...")
    compressed_cache_file_npcs = Path(config.EXTRACTION_CACHE_PATH / "npcs.json")
    extract_monsters_cache_data.extract_monsters_cache_data(compressed_cache_file_npcs)
