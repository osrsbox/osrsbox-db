...
def test_osrs_cache_extract_model_ids_int(path_to_cache_dir: Path, definition_id, cache_type, expected):
    ...
    model_data = extract_summary_model_ids.extract_model_ids_int(json_data)
